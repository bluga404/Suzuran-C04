...
// MARK: - AVFoundation Camera Management
...
class CameraManager: NSObject, ObservableObject, AVCapturePhotoCaptureDelegate {
    ...
    private func setupSession() {
        ...
        return // AVFoundation camera doesn't work on simulator
        #else
    ...
    func capturePhoto() {
        #if targetEnvironment(simulator)
        // Simulate capture on simulator (fallback to a red image for testing)
